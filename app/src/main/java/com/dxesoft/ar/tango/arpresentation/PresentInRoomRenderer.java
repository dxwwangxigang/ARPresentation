 ...
 * method.
 */
public class PresentInRoomRenderer extends Renderer {
    private static final String TAG = PresentInRoomRenderer.class.getSimpleName();
    ...
    public PresentInRoomRenderer(Context context) {
        super(context);
    }
