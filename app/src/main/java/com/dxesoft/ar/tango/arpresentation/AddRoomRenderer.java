 ...
 * method.
 */
public class AddRoomRenderer extends Renderer {
    private static final String TAG = AddRoomRenderer.class.getSimpleName();
    ...
    public AddRoomRenderer(Context context) {
        super(context);
    }
